...
This file is the quick-reference operating contract for tokio-kotlin. The longer
...
tokio-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tokio`](https://crates.io/crates/tokio). Upstream Rust is the behavioral oracle while the
